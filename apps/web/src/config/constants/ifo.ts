import { ERC20Token, ChainId } from '@tiwatoyin/dyleum-sdk'
import { coreTokens } from '@pancakeswap/tokens'
import { CAKE_BNB_LP_MAINNET } from './lp'
import { Ifo } from './types'

export const cakeBnbLpToken = new ERC20Token(ChainId.CORE, CAKE_BNB_LP_MAINNET, 18, 'CAKE-BNB LP')
...
const ifos: Ifo[] = [
  /*
  {
    ...
    currency: coreTokens.tw,
    token: coreTokens.arena,
